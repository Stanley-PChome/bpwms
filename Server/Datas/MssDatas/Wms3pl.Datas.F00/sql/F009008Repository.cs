...
namespace Wms3pl.Datas.F00
{
	...
	{
		public IQueryable<F009008> GetData(string name)
		{
			var param = new object[] { name };
			var sql = @"SELECT * FROM F009008 WHERE NAME = @p0 AND STATUS IS NULL";
			return SqlQuery<F009008>(sql, param);
		}
      ...
      var sql = @" INSERT INTO F009008(DC_CODE,GUP_CODE,CUST_CODE,NAME,SEND_DATA,RETURN_DATA,ERRMSG,STATUS,

...
namespace Wms3pl.Datas.F05
{
    public partial class F051601Repository : RepositoryBase<F051601, Wms3plDbContext, F051601Repository>
	{
        ...
        {
            var parms = new List<object> { DateTime.Now, Current.Staff, Current.StaffName, dcCode, gupCode, custCode, batchNo };
            var sql = @" INSERT INTO F051601(DC_CODE,GUP_CODE,CUST_CODE,BATCH_DATE,BATCH_NO,ITEM_CODE,ITEM_NAME,ITEM_UNIT,PACK_LABEL,PACK_QTY,STATUS,CRT_DATE,CRT_STAFF,CRT_NAME)
									SELECT A.DC_CODE,A.GUP_CODE,A.CUST_CODE,D.BATCH_DATE,D.BATCH_NO ,A.ITEM_CODE,E.ITEM_NAME,F.ACC_UNIT_NAME ITEM_UNIT,COUNT(DISTINCT B.RETAIL_CODE) PACK_LABEL,SUM(B_PICK_QTY) PACK_QTY,'0' STATUS,@p0 CRT_DATE,@p1 CRT_STAFF,@p2 CRT_NAME
										FROM F051202 A
										JOIN F050801 B

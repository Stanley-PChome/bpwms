...
namespace Wms3pl.WebServices.Process.P08.Services
{
    ...
    [OperationContract]
        ...
        [OperationContract]
        public FinishCurrentBoxExecuteResult FinishCurrentBox(F050801 f050801, F055001 f055001, bool isCompletePackage)
        {
            var wmsTransaction = new WmsTransaction();
            var p080701Service = new P080701Service(wmsTransaction);
            var result = p080701Service.FinishCurrentBox(ref f050801, ref f055001, isCompletePackage);
        ...
        public ExecuteResult CheckOrderNo(string dcCode, string gupCode, string custCode, string orderNo, string empId)
            ...
            var result = p080613Service.CheckOrderNo(dcCode, gupCode, custCode, orderNo, empId);
			      if(!result.IsSuccessed)
							return result;
						else
						{

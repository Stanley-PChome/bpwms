...
namespace Wms3pl.WebServices.FromWcsWebApi.Business.mssql.Services
{
  ...
  public class CommonOutWarehouseReceiptService
  {
    ...
    private TransApiBaseService TacService
    {
    ...
    #region F060201Repository
    private F060201Repository _F060201Repo;
    public F060201Repository F060201Repo
    {
      get { return _F060201Repo == null ? _F060201Repo = new F060201Repository(Schemas.CoreSchema, _WmsTransaction) : _F060201Repo; }
      set { _F060201Repo = value; }
    }
    #endregion


    #region F060202Repository
    private F060202Repository _F060202Repo;
    public F060202Repository F060202Repo
    {
      get { return _F060202Repo == null ? _F060202Repo = new F060202Repository(Schemas.CoreSchema, _WmsTransaction) : _F060202Repo; }
      set { _F060202Repo = value; }
    }
    #endregion

    #region F060203Repository
    private F060203Repository _F060203Repo;
    public F060203Repository F060203Repo
    {
      get { return _F060203Repo == null ? _F060203Repo = new F060203Repository(Schemas.CoreSchema, _WmsTransaction) : _F060203Repo; }
      set { _F060203Repo = value; }
    }
    #endregion

    #region F060204Repository
    private F060204Repository _F060204Repo;
    public F060204Repository F060204Repo
    {
      get { return _F060204Repo == null ? _F060204Repo = new F060204Repository(Schemas.CoreSchema, _WmsTransaction) : _F060204Repo; }
      set { _F060204Repo = value; }
    }
    #endregion

    #region F060205Repository
    private F060205Repository _F060205Repo;
    public F060205Repository F060205Repo
    {
      get { return _F060205Repo == null ? _F060205Repo = new F060205Repository(Schemas.CoreSchema, _WmsTransaction) : _F060205Repo; }
      set { _F060205Repo = value; }
    }
    #endregion

    #region F060206Repository
    private F060206Repository _F060206Repo;
    public F060206Repository F060206Repo
    {
      get { return _F060206Repo == null ? _F060206Repo = new F060206Repository(Schemas.CoreSchema, _WmsTransaction) : _F060206Repo; }
      set { _F060206Repo = value; }
    }
    #endregion
    ...
    #region F151002Repository
    private F151002Repository _F151002Repo;
    public F151002Repository F151002Repo
    {
      get { return _F151002Repo == null ? _F151002Repo = new F151002Repository(Schemas.CoreSchema, _WmsTransaction) : _F151002Repo; }
      set { _F151002Repo = value; }
    }
    #endregion
    ...
    #region F051201Repository
    private F051201Repository _F051201Repo;
    public F051201Repository F051201Repo
    {
      get { return _F051201Repo == null ? _F051201Repo = new F051201Repository(Schemas.CoreSchema, _WmsTransaction) : _F051201Repo; }
      set { _F051201Repo = value; }
    }
    #endregion
    ...
    #region F051203Repository
    private F051203Repository _F051203Repo;
    public F051203Repository F051203Repo
    {
      get { return _F051203Repo == null ? _F051203Repo = new F051203Repository(Schemas.CoreSchema, _WmsTransaction) : _F051203Repo; }
      set { _F051203Repo = value; }
    }
    #endregion
    ...
    #region F075106Repository
    private F075106Repository _F075106Repo;
    public F075106Repository F075106Repo
    {
      get { return _F075106Repo == null ? _F075106Repo = new F075106Repository(Schemas.CoreSchema, _WmsTransaction) : _F075106Repo; }
      set { _F075106Repo = value; }
    }
    #endregion
    ...
    public CommonOutWarehouseReceiptService()
    {
              ...
              else
              {
                if (receipt.Status == 0)
                {
                  ...
                  else
                  {
                    ...
                    f060201.STATUS = "4";
                    F060201Repo.UpdateFields(new { f060201.STATUS }, x => x.DOC_ID == f060201.DOC_ID && x.CMD_TYPE == f060201.CMD_TYPE);
                ...
                else if (receipt.Status == 3)
                {
                  ...
                  {
                    F060202Repo = new F060202Repository(Schemas.CoreSchema, _WmsTransaction);
                    F060203Repo = new F060203Repository(Schemas.CoreSchema, _WmsTransaction);
                    F060204Repo = new F060204Repository(Schemas.CoreSchema, _WmsTransaction);
                    F060205Repo = new F060205Repository(Schemas.CoreSchema, _WmsTransaction);
                    F060206Repo = new F060206Repository(Schemas.CoreSchema, _WmsTransaction);
    ...
    protected ApiResult CheckCommonColumnData(string dcCode, string gupCode, string custCode, string wmsNo, OutWarehouseReceiptModel receipt, F060201 f060201)
    {
      ...
      ciwService.TacService = TacService;
      ApiResult res = new ApiResult();
      List<ApiResponse> data = new List<ApiResponse>();

namespace Wms3pl.Datas.F05
{
  ...
  public class F050301 : IEncryptable, IAuditInfo
  {
    ...
    /// <summary>
    /// 配庫暫存編號(YYYYMMDDhhmm-00)
    /// </summary>
    [Required]
    [Column(TypeName = "varchar(15)")]
    public string PICK_TEMP_NO { get; set; }
    ...
    //    get
    //    {
    //        return new Dictionary<string, string> { { "TEL", "TEL" }, { "ADDRESS", "ADDR" }, { "CONSIGNEE", "NAME" }, { "CONTACT", "NAME" }, { "CONTACT_TEL", "TEL" }, { "TEL_AREA", "NOT" }, { "TEL_1", "TEL" }, { "TEL_2", "TEL" }, { "ADDRESS_PARSE", "ADDR" } };
    //    }
    //}
    ...
    /// </summary>
    [Column(TypeName = "varchar(10)")]
    public string USER_DIRECT_PRIORITY_CODE { get; set; }

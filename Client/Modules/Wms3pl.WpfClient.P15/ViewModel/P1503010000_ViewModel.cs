...
{
	public partial class P1503010000_ViewModel : InputViewModelBase
	{
		...
		private void DoSearch()
		{
			...
			var qry = (from a in proxy.F0010s.ToList()
					   ...
					   select new DgDataClass
					   {
						   ...
						   ORD_NO = a.ORD_NO,
						   STATUS = a.STATUS,
						   STATUS_DESC = a.STATUS == "0" ? Properties.Resources.P1503010000_Pending : Properties.Resources.P1503010000_Processed,

...
namespace Wms3pl.WpfClient.P19.Services
{
	...
	public static class FunctionDisabled
	{
		public static string Yes = "1";
		public static string No = "0";
	}

	public static class P190503Datas
	{
		...
		public static List<NameValuePair<string>> Status
		{
			get
			{
				return new List<NameValuePair<string>>() {
					new NameValuePair<string>() {Name=Resources.Resources.All, Value=""},
					new NameValuePair<string>() {Name=Properties.Resources.UnPublish, Value="2"},
					new NameValuePair<string>() {Name=Properties.Resources.WaitForAuthorization, Value="0"},
					new NameValuePair<string>() {Name=Properties.Resources.Authorized, Value="1"},
					new NameValuePair<string>() {Name=Resources.Resources.Alert, Value="3"},
					new NameValuePair<string>() {Name=Properties.Resources.DisableProgram, Value="9"}
				};
			}
		}
	}

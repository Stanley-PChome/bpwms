...
namespace Wms3pl.WpfClient.P05.ViewModel
{
	...
	/// UI繪製用Class,開發後無用須刪除
	/// </summary>
	public partial class P0500000000_ViewModel : InputViewModelBase
	{
		public P0500000000_ViewModel()
		{
			if (!IsInDesignMode)
			{
				//初始化執行時所需的值及資料				
    ...
    public List<DgDataClass> DgItemSource6 { get; set; }
    ...
    public List<DgDataClass2> DgItemSource2 { get; set; }
    public class DgDataClass2
    {
      public string Str1 { get; set; }
      public string Str2 { get; set; }
      public string Str3 { get; set; }
    ...
    public List<DgDataClass3> DgItemSource3 { get; set; }
    public class DgDataClass3
    {
      public string Str1 { get; set; }
      public string Str2 { get; set; }
      public string Str3 { get; set; }
